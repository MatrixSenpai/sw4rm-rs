...
impl Identifier {
    ...
    pub fn trait_rep(&self, is_using_camel_transform: bool) -> (String, bool) {
        self.change_rep(Case::UpperCamel, is_using_camel_transform)
    }
    ...
    pub fn raw_value(&self) -> String { self.0.clone() }
}
